        ...
        <div className="max-w-[450px] h-[500px] mx-auto bg-black/75">
          <div className="max-w-[320px] mx-auto py-16 text-white">
            ...
            <form className="flex flex-col w-full py-4" >
              <input className="p-3 my-2 bg-gray-600 rounded outline-none " type="email"placeholder="Email" autoComplete="email" />
              <input className="p-3 my-2 bg-gray-600 rounded outline-none"  type="password" placeholder="Password" autoComplete="current-password" />
              <button className="bg-red-600 py-3 my-6 rounded font-bold">Sign Up</button>
           <div><p><input type="checkbox" /> Remember me</p></div>
            </form>
          </div>
        </div>
      </div>
